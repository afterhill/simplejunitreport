...
public class Arrays {
	 ...
	 * @param array
	 *            the array to check.
	 * @return {@code true} if the given array is {@code null} or empty,
	...
	<T> T[] array(@Nonnull T... values) {
		return checkNotNull(values);
	}

	/**
	 * Returns the {@code String} representation of the given array, or
	 * {@code null} if the given object is either {@code null} or not an array.
	...
	String format(@Nullable Object array) {
	...
	/**
	 * Returns {@code true} if the given array has only {@code null} elements,
	 * {@code false} otherwise. If given array is empty, this method returns
	 * {@code true}.
	 * 
	 * @param <T>
	 *            the type of elements of the array.
	 * @param array
	 *            the given array. <b>It must not be null</b>.
	 * @return {@code true} if the given array has only {@code null} elements or
